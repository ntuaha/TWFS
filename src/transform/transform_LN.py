...
class TRANSFORM_LN:
	...
	columns = ["貼現透支","短期放款","中長期放款","進出口押匯"]	
	columns_en = ["LN_DO","LN_ST","LN_ML","LN_AO"]	
	...
	def parse(self):
		...
		for sheet_num in range(book.nsheets):
			...
			for i in range(sh.nrows):
				...
				self.total_data[3] = int(float(sh.cell_value(rowx=i,colx = 3))*1e6)
...
#	parser = TRANSFORM_LN('/Users/aha/Dropbox/Project/Financial/Plan/rawdata/','/Users/aha/Dropbox/Project/Financial/Plan/data/')
#	parser.runParse('10001')
#	parser.runParse('10002')
	parser = TRANSFORM_LN('/home/aha/Data/TWFS/rawdata/','/home/aha/Data/TWFS/data/')
	parser.parseAll()
